...
void setup() {
  ...
  stepper2.moveTo(-1200);    //DERECHO. positivo abre, negativo cierra
  stepper3.setMaxSpeed(vel_gancho);
  stepper3.setAcceleration(acel_gancho);
  stepper3.moveTo(-1200);    //IZQUIERDO. positivo abre, negativo cierra
  
  // setup para ajustar motores 4 y 5 
  stepper4.setMaxSpeed(vel_enrol);
  stepper4.setAcceleration(acel);
  stepper4.moveTo(-(steps_enrol+steps_enrol_demas));    //dirección en funcionamiento normal: positiva.
  stepper5.setMaxSpeed(vel_enrol);
  stepper5.setAcceleration(acel);
  stepper5.moveTo((steps_enrol+steps_enrol_demas));    //dirección en funcionamiento normal: negativa.
