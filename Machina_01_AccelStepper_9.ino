...
float vel_solid_meand = 0.63*(vel_meand * steps_solid_meand / steps_meand);  // CON reductora
// sin Reductora
...
void setup() {
  ...
  stepper2.moveTo(-1800);    //DERECHO. positivo abre, negativo cierra
  stepper3.setMaxSpeed(vel_gancho);
  stepper3.setAcceleration(acel_gancho);
  stepper3.moveTo(-1800);    //IZQUIERDO. positivo abre, negativo cierra
  
  // setup para ajustar motores 4 y 5 
  stepper4.setMaxSpeed(vel_enrol);
  stepper4.setAcceleration(acel);
  stepper4.moveTo(steps_enrol_demas);    //dirección en funcionamiento normal: positiva. 
  stepper5.setMaxSpeed(vel_enrol);
  stepper5.setAcceleration(acel);
  stepper5.moveTo(-steps_enrol_demas);    //dirección en funcionamiento normal: negativa. 
  ...
  stepper7.moveTo(steps_meand);    //dirección en funcionamiento normal: positiva. steps_meand. IZQUIERDO
