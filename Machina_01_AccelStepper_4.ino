...
int steps_gancho  = 3000;        // 0.8 mm/vuelta
int steps_gancho_corte = 600;   // 0.8 mm/vuelta. 1*200
int steps_cable = 0.5*300/8*200;    // 8 mm/vuelta. 
...
//    stepper3.moveTo(steps_gancho/5);    //CAMBIAR 
}
