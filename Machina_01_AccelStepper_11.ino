...
int steps_gancho_corte = 90;   // 1.25 mm/vuelta.
int steps_cable = (191 + 4)/ 8 * 200 ; // 8 mm/vuelta. Distancia recorrida por motor 8 (eje X). Define el largo del cable 
int steps_enrol = 600;          // una vuelta considerando reducción 
int steps_meand = (2760 + 2);          // tres vueltas
...
float vel_solid_meand = 0.69*(vel_meand * steps_solid_meand / steps_meand);  // CON reductora  // ESTABA EN 0.69
// sin Reductora
...
void setup() {
  ...
  stepper7.moveTo(steps_meand/6);    //dirección en funcionamiento normal: positiva. steps_meand. IZQUIERDO
