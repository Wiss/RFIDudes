...
float steps_solid_enrol = steps_enrol*31.5/4; //Por cada vuelta del motor 4 y 5 se avanzan 31.5*2 mm. Entonces, el mot9 necesita 31.5*2/8 vueltas (8 mm por vuelta mot 9)
float steps_solid_meand = steps_meand*9.56/2;    //Por cada vuelta del motor 6 y 7 se avanzan ((15.56-6)*2)*2 mm. Entonces, el mot9 necesita 9.56*2*2/8 vueltas (8 mm por vuelta mot 9)
...
int acel = 1000;                 //Aceleración igual para todos los motores
 ...
 **************/
  ...
  if (Paso == 3){
    ...
    stepper9.setAcceleration(acel);
    stepper9.setSpeed(vel_solid_enrol);  //setMaxSpeed? REVISAR
 ...
 **************/
  ...
  if (Paso == 4){
    ...
    stepper9.setAcceleration(acel);
    stepper9.setSpeed(vel_solid_meand);     //setSpeed? REVISAR
